...
public class IOClass
{
	...
	public static String IOKWPerTon(float KW, float KG)
	{
		return PowerToWeightCalculator.KWPerTon(KW, KG) + " KW per Ton";
	}
	...
	public static String IOQuarterMileTime(float HP, float KG)
	{
	...
	public static String IOCalculateCylinderVolume(float bore, float stroke)
	{
		return VolumeCalculator.CalculateCylinderVolume(bore, stroke) + " CC";
	}

	public static String IOCalculateEngineVolume(float bore, float stroke, int NumberOfCyls)
	{
